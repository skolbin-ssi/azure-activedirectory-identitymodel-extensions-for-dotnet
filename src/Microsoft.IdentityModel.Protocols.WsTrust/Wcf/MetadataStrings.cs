...
namespace Microsoft.IdentityModel.Wcf
{
    internal static class MetadataStrings
    {
        ...
        public static class Addressing200408
        {
            ...
            public const string NamespaceUri = WsAddressing200408Constants.Namespace;

            public static class Policy
            {
                public const string Prefix = "wsap";
                public const string NamespaceUri = WsAddressing200408Constants.Namespace + "/policy";
        ...
        public static class Addressing10
        {
            ...
            public const string NamespaceUri = WsAddressing10Constants.Namespace;
